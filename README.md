...
#### next
- Since all state transitions happen simultaneously, I make a copy of the previous array, and fill it in as I go along, using the information from the previous state without effecting the next one as I go.
